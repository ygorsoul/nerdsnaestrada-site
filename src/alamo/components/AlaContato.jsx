...
// Endereços e handles ficam aqui porque não são texto de proposta.
const contatos = [
...
export default function AlaContato() {
  const { contato } = textos

  return (
    <section id="contato" className="closing faixa-clara textura">
      <div className="wrap">
