...
export default function AlaHero() {
  const { hero } = textos
    ...
    <section className="hero">
      ...
      <div className="hero-route" aria-hidden="true">
        <svg viewBox="0 0 400 800" preserveAspectRatio="xMidYMid meet">
          ...
          />
          <circle cx="340" cy="20" r="6" />
          <circle cx="80" cy="790" r="6" />
        </svg>
      </div>
      <div className="wrap">
        <div className="co-lockup">
          <div className="side">
            <img className="nne" src="/alamo/logo-nne.png" alt={hero.lockup.nne.nome} />
            <div className="meta"><b>{hero.lockup.nne.nome}</b>{hero.lockup.nne.meta}</div>
          </div>
          <span className="co-x">×</span>
          <div className="side">
            <img className="ala" src="/alamo/logo-alamo-navy.png" alt={hero.lockup.ala.nome} />
            <div className="meta"><b>{hero.lockup.ala.nome}</b>{hero.lockup.ala.meta}</div>
          </div>
        </div>
        <h1 className="headline">
          ...
          <span className="brand-line">{hero.manchete.marca}</span>
        </h1>
        <p className="hero-sub"><Rich texto={hero.sub} /></p>
        <div className="hero-cta">
          <a href="#investimento" className="btn">{hero.ctaProposta}</a>
